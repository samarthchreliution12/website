...
import { Workflow, Boxes, Activity, LucideIcon } from "lucide-react";
    ...
    <section className={styles.section}>
      <div className={styles.container}>
        <div className={styles.sectionHeader}>
          ...
          >
            {MANUFACTURING_INDUSTRY_DATA.odooSolutionsTitle}
          </motion.h2>
          <p className={styles.sectionDesc}>
            {MANUFACTURING_INDUSTRY_DATA.odooSolutionsDesc}
          </p>
        </div>

        <div className={styles.cardGrid3}>
          {MANUFACTURING_INDUSTRY_DATA.odooSolutions.map((item, idx) => {
            const IconComp = ICON_MAP[item.iconName] || Workflow;
            return (
              <motion.div
                key={idx}
